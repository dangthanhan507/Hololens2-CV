...
if __name__ == '__main__':
    ...
    while enable:
        ...
        world2depth_transform = kin_chain.compute_transform("world", "depth", data_lt.pose.T)
        #detect
        ...
        for n in range(len(boxes)):
            ...
            bbox2d = cv_utils.create_bbox(depth_pts2d, "reproject vlc cup")
        ...
        for n in range(len(boxes)):
            ...
            depth_pts2d = sensor_stack.project_onto_depth_frame(pts_3d, world2depth_transform)
            bbox2d = cv_utils.create_bbox(depth_pts2d, "reproject rgb cup")
            bbox2d.drawBox(real_depth_img)
